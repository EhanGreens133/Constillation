...
import { SESSION_COOKIE, createSessionToken, safeNext, sessionCookieOptions, verifyToken } from "@/lib/auth";
...
export async function GET(req: Request) {
  ...
  const res = NextResponse.redirect(new URL(next, env.appOrigin));
